...
function ka(e, n, t) {
    return Nn & 21
        ? (Me(t, n) ||
              ((t = Ps()), ($.lanes |= t), (zn |= t), (e.baseState = !0)),
          n)
...
function id(e, n, t, r, l, o, u) {
    ...
    if (l.data === "$!") {
        ...
        return (
            (r = i), (o = Error(y(419))), (r = Al(o, r, void 0)), pr(e, n, u, r)
        );
    }
...
function dd(e, n) {
    ...
    for (
        vo = { focusedElem: e, selectionRange: t }, Dr = !1, k = n;
        k !== null;
...
Ql.createRoot(document.getElementById("nav")).render(
